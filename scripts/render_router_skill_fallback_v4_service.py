...
from nano_harness.router_skill_fallback_v4 import load_config
...
RAW_FOUR_HEALTH = (
    ROOT
    / "results/harness/qwen35-router-skill-fallback-v4/services/"
    "four.models.json"
)
RAW_NINE_HEALTH = (
    ROOT
...
def build_receipt() -> dict:
    ...
    if (
        ...
        raise ValueError("router skill fallback v4 preregistration differs")
    ...
    if (
        ...
        raise ValueError("router skill fallback v4 service health differs")
    return {
        "schema_version": "nano_harness_router_skill_fallback_v4_service",
        ...
        "v4_generation_started": False,
        "integration_v1_v2_v3_rerun": False,
        "benchmark_accessed": False,
        "canary_accessed": False,
        "holdout_accessed": False,
        "claim_boundary": (
            "This receipt proves only 4B, 9B, and remapped-router service "
            "readiness for V4. It contains no generation or quality evidence."
        ),
    }
        ...
        json.dumps(
            {
                ...
                "v4_generation_started": receipt["v4_generation_started"],
                "output": str(OUTPUT),
            },
            indent=2,
            sort_keys=True,
